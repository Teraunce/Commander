...
namespace Commander {
    static class FeatTools {
        ...
        public static BlueprintFeature CreateSkillFeat(string name, string guid, StatType skill1, StatType skill2, Action<BlueprintFeature> init = null) {
            var SkillFeat = Helpers.CreateBlueprint<BlueprintFeature>(name, guid, bp => {
                bp.Ranks = 1;
        ...
        public static BlueprintFeature CreateExtraResourceFeat(string name, string guid, BlueprintAbilityResource resource, int amount, Action<BlueprintFeature> init = null) {
            var extraResourceFeat = Helpers.CreateBlueprint<BlueprintFeature>(name, guid, bp => {
                bp.Ranks = 10;
                bp.ReapplyOnLevelUp = true;
                bp.IsClassFeature = true;
                bp.Groups = new FeatureGroup[] { FeatureGroup.Feat };
        ...
        public static BlueprintFeatureSelection CreateExtraSelectionFeat(string name, string guid, BlueprintFeatureSelection selection, Action<BlueprintFeatureSelection> init = null) {
            var extraResourceFeat = Helpers.CreateBlueprint<BlueprintFeatureSelection>(name, guid, bp => {
                bp.ReapplyOnLevelUp = true;
                bp.IsClassFeature = true;
                bp.Groups = new FeatureGroup[] { FeatureGroup.Feat };
